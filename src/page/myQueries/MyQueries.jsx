      ...
      {loading ? (
        ...
        <div>
          ...
          <div className={`grid ${gridCols} gap-3 lg:gap-6`}>
            {queries.map((item) => (
              <Zoom key={item._id}>
                <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-xl shadow-lg p-4 border border-gray-700 transform transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
                  <Fade>
                    <div className="h-32 w-full flex justify-center items-center mb-4 bg-gray-700 rounded-lg">
                      <img
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <Link to={`/queryDetails/${item._id}`}>
                      <button className="px-4 py-2 rounded-lg bg-blue-600 text-white font-semibold shadow-md transition-all duration-300 hover:bg-blue-500 hover:shadow-blue-500/50 hover:scale-110">
                        View
                      </button>
                    </Link>
                    <Link to={`/update/${item._id}`}>
                      <button className="px-4 py-2 rounded-lg bg-green-600 text-white font-semibold shadow-md transition-all duration-300 hover:bg-green-500 hover:shadow-green-500/50 hover:scale-110">
                        Update
                      </button>
                    </Link>
                    <button
                      className="px-4 py-2 rounded-lg bg-red-600 text-white font-semibold shadow-md transition-all duration-300 hover:bg-red-500 hover:shadow-red-500/50 hover:scale-110"
