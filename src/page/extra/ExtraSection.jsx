  ...
  return (
    <div className="   ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <Fade delay={200}>
          <div className="p-6 bg-gray-800 border-r-4 border-fuchsia-600 text-gray-400 rounded-lg shadow-lg hover:shadow-2xl transition-transform transform hover:scale-105">
        ...
        <Fade delay={300}>
          <div className="p-6 bg-gray-800 border-r-4 border-r-violet-700 text-gray-400 rounded-lg shadow-lg hover:shadow-2xl transition-transform transform hover:scale-105">
        ...
        <Fade delay={400}>
          <div className="p-6 bg-gray-800 border-r-4 border-r-orange-300 text-gray-400 rounded-lg shadow-lg hover:shadow-2xl transition-transform transform hover:scale-105">
        ...
        <Fade delay={600}>
          <div className="p-6 bg-gray-800 border-r-4 border-red-300 text-gray-400 rounded-lg shadow-lg hover:shadow-2xl transition-transform transform hover:scale-105">
        ...
        <Fade delay={700}>
          <div className="p-6 bg-gray-800 border-r-4 border-rose-700 text-gray-400 rounded-lg shadow-lg hover:shadow-2xl transition-transform transform hover:scale-105">
